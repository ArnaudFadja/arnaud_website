...
class ThesesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create thesis" do
    assert_difference('Thesis.count') do
      post theses_url, params: { thesis: { description: @thesis.description, title: @thesis.title, year: @thesis.year } }
    end
  ...
  test "should update thesis" do
    patch thesis_url(@thesis), params: { thesis: { description: @thesis.description, title: @thesis.title, year: @thesis.year } }
