...
class TeachingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create teaching" do
    assert_difference('Teaching.count') do
      post teachings_url, params: { teaching: { description: @teaching.description, title: @teaching.title, year: @teaching.year } }
    end
  ...
  test "should update teaching" do
    patch teaching_url(@teaching), params: { teaching: { description: @teaching.description, title: @teaching.title, year: @teaching.year } }
